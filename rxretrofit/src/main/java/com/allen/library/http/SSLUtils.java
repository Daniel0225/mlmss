...
public class SSLUtils {
    public static final String KEY_STORE_CLIENT_PATH = "client.p12";//客户端证书
    public static final String KEY_STORE_TRUST_PATH = "client.truststore";//服务端预埋证书
    private static final String KEY_STORE_TYPE_BKS = "bks";
    private static final String KEY_STORE_TYPE_P12 = "PKCS12";
    private final static String PROTOCOL_TYPE = "TLS";//协议类型
    /**
    ...
    private static SSLParams getSslSocketFactoryBase(X509TrustManager trustManager, InputStream bksFile, String password, InputStream... certificates) {
        ...
        try {
            ...
            TrustManager[] trustManagers = prepareTrustManager(password, certificates);
    ...
    private static TrustManager[] prepareTrustManager(String password, InputStream... certificates) {
