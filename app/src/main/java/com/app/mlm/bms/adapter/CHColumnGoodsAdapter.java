 ...
 * @date : 2019/1/3  20:32
 * @describe : 出货测试 -- 多列商品Adapter
 * @org : www.taojiji.com
 * @email : xing.luo@taojiji.com
 */
public class CHColumnGoodsAdapter extends RecyclerView.Adapter<CHColumnGoodsAdapter.RowGoodsViewHolder> {
    private Context context;
    private List<List<GoodsInfo>> data = new ArrayList<>();
    public CHColumnGoodsAdapter(Context context, List<List<GoodsInfo>> data){
