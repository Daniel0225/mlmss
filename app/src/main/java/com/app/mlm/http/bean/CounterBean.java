...
public class CounterBean implements Serializable {
    ...
    private String containerTwoNo;
    private String containerTwoName;
    ...
    public String getContainerTwoNo() {
        return containerTwoNo;
    }

    public void setContainerTwoNo(String containerTwoNo) {
        this.containerTwoNo = containerTwoNo;
    }

    public String getContainerTwoName() {
        return containerTwoName;
    }

    public void setContainerTwoName(String containerTwoName) {
        this.containerTwoName = containerTwoName;
    }
}
